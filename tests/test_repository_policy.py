...
def test_phase24_entrypoints_ci_and_runner_select_the_active_phase() -> None:
    ...
    assert "verify_phase1.py --static-only --phase 24" in workflow
    assert "verify_phase1.py --phase 24" in workflow
    ...
    for closure_control in (
        ...
        "changed_paths - PHASE_24_ALLOWED_WRITES",
        "verify_phase11_api(",
        ...
        "verify_phase24_portable_acceptance(",
