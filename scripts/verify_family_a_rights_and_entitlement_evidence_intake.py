"""Verify one bounded canonical Phase 27 rights-and-entitlement evidence artifact."""
...
FAILURE_MESSAGE = "Phase 27 rights-and-entitlement evidence verification failed.\n"
...
def main(argv: Sequence[str] | None = None) -> int:
    try:
        ...
        if arguments.artifact.is_symlink() or not arguments.artifact.is_file():
            raise _InvalidInvocation
            ...
            c.canonical_json_bytes(
                {
                    ...
                    "verified": True,
                    "verified_evidence_recorded": artifact.verified_evidence_recorded,
                }
            )
            + b"\n"
        )
